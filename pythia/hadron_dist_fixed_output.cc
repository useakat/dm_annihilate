...
//// Life time > 10^-10 s ////////////
  ...
  for (int i = 0; i < nbins+1; ++i) {
    ofsnp << fixed << 2*mDM << " " << x[i] << " " << nnN[i]/nevents << " " << nnP[i]/nevents << " " 
  ...
  ofsnini << fixed << 2*mDM << " " << totN/nevents << " " << totP/nevents << " " << totpip/nevents << " " 
	  << totpim/nevents << " " << totKp/nevents << " " << totKm/nevents << " " << totKL/nevents << " " 
	  << totaN/nevents << " " << totaP/nevents << endl;

  cout << fixed << totGam/nevents << " " << totEle/nevents << " " << totN/nevents << " " << totP/nevents << " " 
...
//// Life time > 10^-10 s ////////////
  ...
  cout << fixed << 2*mDM << " " << Ekin/nevents << " "  << Ekin/(2*mDM)/nevents << " " << Ekin_other/nevents << " " << nevents << endl;
